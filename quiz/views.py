...
def quiz_list(request, slug):
    ...
    log_learning_activity(
        ...
        description=f"Viewed quiz list for course {course.code}",
        course=course,
    )
    return render(
...
class QuizTake(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        log_learning_activity(
            request.user,
            LearningActivity.ACTIVITY_TAKE_QUIZ,
            description=f"Started quiz {self.quiz.title} ({self.quiz.id})",
            course=self.course,
        )
    ...
    def final_result_user(self):
        ...
        log_learning_activity(
            ...
            description=(
                f"Finished quiz {self.quiz.title} with "
                f"{self.sitting.get_percent_correct}%"
            ),
            course=self.course,
        )
